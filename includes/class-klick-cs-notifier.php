...
if (class_exists('Klick_Cs_Notifier')) return;

/**
 * Class Klick_Cs_Notifier
 */
class Klick_Cs_Notifier {
	...
	/**
	 * Klick_Cs_PHP_Notifier constructor
	...
	public function __construct() {
		...
		$folder = opendir(KLICK_CS_PLUGIN_MAIN_PATH . 'notices');
	...
	public function add_noitice($notice_file) {
		...
		$notice_file = KLICK_CS_PLUGIN_MAIN_PATH . 'notices' . '/' . $notice_file;
